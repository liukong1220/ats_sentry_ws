...
export ROS_HOME="/home/ats/pd/pb2025_sentry_ws"
cd /home/ats/pd/pb2025_sentry_ws
# 设置需要启动和监视的ros命令
declare -a commands=("ros2 launch standard_robot_pp_ros2 standard_robot_pp_ros2.launch.py")
