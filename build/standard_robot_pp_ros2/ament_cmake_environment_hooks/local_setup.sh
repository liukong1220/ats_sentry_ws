...
: ${AMENT_CURRENT_PREFIX:="/home/ats/ats_sentry_ws/install/standard_robot_pp_ros2"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/standard_robot_pp_ros2/environment/library_path.sh"
